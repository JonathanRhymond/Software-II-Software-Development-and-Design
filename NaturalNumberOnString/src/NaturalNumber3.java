...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final int divideBy10() {
        ...
        // Get the last digit of the number as an integer
        int lastDigit = 0;

        // Create a new string without the last digit
        // Check if the number is already 0
        if (this.rep.length() == 0) {
            return 0;
        } else if (this.rep.length() == 1) {
            // If only one digit, set rep to 0
            lastDigit = Integer.parseInt(this.rep);
            this.rep = "0";
        } else if (this.rep.length() > 1) {
            lastDigit = Integer.parseInt(this.rep
    ...
    public final boolean isZero() {
        ...
        boolean checkValue = (this.rep.equals("0") || this.rep.isEmpty());
