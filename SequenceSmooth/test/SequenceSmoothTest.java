...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth for correct values with s1 = < 357, 357 > and s2 = < >
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(357, 357);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(357, 357);
        Sequence<Integer> seq2 = this.createFromArgs();
        Sequence<Integer> expectedSeq2 = this.createFromArgs(357);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth for correct values with s1 = < -357, 357 > and s2 = < 256 >
     */
    @Test
    public void test4() {
        /*
        ...
        Sequence<Integer> seq1 = this.createFromArgs(-357, 357);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-357, 357);
        Sequence<Integer> seq2 = this.createFromArgs(256);
    ...
    /**
     * Test smooth for correct values with s1 = < 357, -357 > and s2 = < 333 >
     */
    @Test
    public void test5() {
        /*
        ...
        Sequence<Integer> seq1 = this.createFromArgs(357, -357);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(357, -357);
        Sequence<Integer> seq2 = this.createFromArgs(333);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(0);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
    ...
    /**
     * Test smooth for correct values with s1 = < 1073741825, 1073741825 > and
     * s2 = < 333 >
     */
    @Test
    public void test6() {
