...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        //initialize the two smart nodes
    ...
    public final void addRightFront(T x) {
        ...
        addedNode.next = this.lastLeft.next;
        this.lastLeft.next.previous = addedNode;

        //link on the left side
        addedNode.previous = this.lastLeft;
        this.lastLeft.next = addedNode;
    ...
    public final T removeRightFront() {
        ...
        //get data from rightFront
        Node removedNode = this.lastLeft.next;

        //change links around the removedNode
    ...
    public final void advance() {
        ...
        //change links to account for change
    ...
    public final void moveToStart() {
        ...
        //change lastLeft to point to front
        this.lastLeft = this.preStart;
    ...
    public final void retreat() {
        ...
        //point lastLeft to the previous
