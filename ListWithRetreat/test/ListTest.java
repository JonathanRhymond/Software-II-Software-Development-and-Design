...
public abstract class ListTest {
    ...
    @Test
    public void testRetreatLeftOneRightEmpty() {
        /*
         * Set up variables
         */
        List<String> test = this.createFromArgsTest(1, "red");
        List<String> ref = this.createFromArgsRef(1, "red");
        /*
         * Call method under test
         */
        test.retreat();
    ...
    @Test
    public void testRetreatLeftNonEmptyRightEmpty() {
        /*
         * Set up variables
         */
        List<String> test = this.createFromArgsTest(3, "green", "red", "blue");
        List<String> ref = this.createFromArgsRef(3, "green", "red", "blue");
        /*
         * Call method under test
         */
        test.retreat();
    ...
    @Test
    public void testRetreatLeftOneRightNoEmpty() {
        /*
         * Set up variables
         */
        List<String> test = this.createFromArgsTest(1, "yellow", "orange",
                "purple", "red");
        List<String> ref = this.createFromArgsRef(1, "yellow", "orange",
                "purple", "red");
        /*
         * Call method under test
         */
    ...
    @Test
    public void testRetreatLeftNonEmptyRightNonEmpty() {
        /*
         * Set up variables
         */
        List<String> test = this.createFromArgsTest(2, "yellow", "orange",
                "green", "purple");
        List<String> ref = this.createFromArgsRef(2, "yellow", "orange",
                "green", "purple");
        /*
         * Call method under test
         */
