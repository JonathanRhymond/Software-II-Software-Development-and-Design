...
public final class BinarySearchTreeMethodsTest {
    ...
    public void removeSmallestTest() {
         ...
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("3", "1", "2");
        //value of t1 becomes just 3 and 2 after we call our method so thats why
        //we compare t1 and t2 to make sure that the 1 got removed.
        BinaryTree<String> t2 = createBSTFromArgs("3", "2");
        /*
         * Call method under test
         */
        String stringVal = BinarySearchTreeMethods.removeSmallest(t1);
        /*
         * Assert that values of variables match expectations
         */
        assertEquals("1", stringVal);
        assertEquals(t2, t1);
    }
