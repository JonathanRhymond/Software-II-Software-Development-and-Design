...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        ...
        //creates name as unnamed which is default behavior
        this.name = "Unnamed";

        //sets context as Map1L with string and statement
        this.context = new Map1L<String, Statement>();

        //sets body as Statement1 as required
    ...
    public final Map<String, Statement> newContext() {
        ...
        //returns newInstance of this.context which will ensure same type
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        //creates new Map with same type as c
        Map<String, Statement> temp = c.newInstance();

        //uses temp to hold original c temporarily
        temp.transferFrom(c);

        //puts original this.context into c
        c.transferFrom(this.context);

        //puts original c into this.context via temp
    ...
    public final Statement newBody() {
        ...
        //returns newInstance of this.body which will ensure same type
    ...
    public final void swapBody(Statement b) {
        ...
        //creates new Statement with same type as c
        Statement temp = b.newInstance();

        //uses temp to hold original b temporarily
        temp.transferFrom(b);

        //puts original this.body into b
        b.transferFrom(this.body);

        //puts original b into this.body via temp
